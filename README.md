...
12. [Динамический импорт и отображение: React.lazy, Suspense](/React/)
### Хуки:
...
### Мемо-компоненты:
20. [React.memo (мемоизация рендера от пропсов фукнц-компонента)](/React/)
21. [React.PureComponent (мемоизация рендера от пропсов и состояния класс-компонента)](/React/)
### Маршрутизация:
22. [Маршрутизация: React Router v5 & v6](/React/Router/React%20Router%3A%20v5%2C%20v6.md)
