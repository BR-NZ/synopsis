...
__`timeout`__ –  - продолжительность перехода в мс, можно определять одним значением для всех переходов или для каждого перехода в отдельности.
...
Как применяются эти классы в зависимости от `state`:  
