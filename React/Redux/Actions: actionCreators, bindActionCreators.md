...
> __Функции-создатели, как правило, содержат в отдельном модуле__ в виде экспортов функций. А при надобности импортируют в тот компонент (модуль), где собираются использовать.
