...
> Функции-создатели, как правило, содержат в отдельном модуле в виде экспортов функций. А при надобности импортируют в тот компонент (модуль), где собираются использовать.
