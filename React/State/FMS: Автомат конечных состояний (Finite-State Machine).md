...
__`Автомат конечных состояний`__ — это подход к проектированию состояний и реагированию на его изменение, который помогает избежать путаницы и ошибок, когда `"глобальное"` состояние всей системы в моменты времени зависит от сразу нескольких факторов `"под-состояний"`. 
